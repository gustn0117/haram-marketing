...
export function Footer() {
  return (
    <footer className="border-t border-line px-6 py-20 md:py-28">
      <Container size="narrow" className="flex flex-col items-start text-left">
        <MonogramSeal variant="static" className="mb-8 w-12 text-gold/45" />
        ...
        <span className="hair-line mt-10 block w-16" aria-hidden />
