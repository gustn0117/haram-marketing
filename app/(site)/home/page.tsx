...
export default function HomePage() {
  return (
    <>
      {/* ── HERO — 풀스크린, 중앙 정렬 균형 (아치가 워드마크를 감쌈) ── */}
      <section className="relative flex min-h-[100svh] flex-col items-center justify-center overflow-hidden px-6 text-center">
        <span className="hero-photo-bg" aria-hidden />
        <span className="hero-glow" aria-hidden />
        {/* 예식 아치 라인아트 — 워드마크를 감싸는 중앙 모티프, 로드 시 그려짐 */}
        <ArchMotif
          variant="load"
          className="pointer-events-none absolute left-1/2 top-1/2 z-1 w-[min(92vw,560px)] -translate-x-1/2 -translate-y-[52%] text-paper/28"
        />
        <span
        ...
        <h1
          className="rise foil relative z-2 mt-9 whitespace-nowrap text-[clamp(1.7rem,7vw,4.8rem)] font-light leading-none tracking-[0.18em]"
          style={{
